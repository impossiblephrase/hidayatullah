      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="mb-6 md:mb-0">
            <h2 className="text-2xl font-bold text-white">Masjid Hidayatullah</h2>
          ...
          <div className="grid grid-cols-3 gap-6">
            <div>
              <h3 className="text-lg text-white font-semibold">Koperasi</h3>
        ...
        <div className="mt-12 text-center text-sm font-serif text-gray-400">
          <p>&copy; {new Date().getFullYear()} DKM Masjid Hidayatullah. Jangnim. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
